...
namespace rw {
	namespace imet {
		class ModelEngine_Yolov11_seg_mask
			:public ModelEngine
		{
		private:
			struct DetectionSeg
		...
		public:
			ModelEngine_Yolov11_seg_mask(const std::string& modelPath, nvinfer1::ILogger& logger);
			~ModelEngine_Yolov11_seg_mask() override;
		private:
