...
namespace rw
{
	namespace rqw
	{
		...
		StandardButton MessageBox::information(QWidget* parent, const QString& title,
		...
		StandardButton MessageBox::warning(QWidget* parent, const QString& title,
			const QString& text, int buttons)
		{
			MessageBox msgBox(parent);
			msgBox.setWindowTitle(title);
		...
		StandardButton MessageBox::critical(QWidget* parent, const QString& title,
			const QString& text, int buttons)
		{
			MessageBox msgBox(parent);
			msgBox.setWindowTitle(title);
		...
		StandardButton MessageBox::question(QWidget* parent, const QString& title,
			const QString& text, int buttons)
		{
			MessageBox msgBox(parent);
			msgBox.setWindowTitle(title);
